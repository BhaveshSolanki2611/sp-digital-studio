    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif;">
          ...
          <p style="margin-top: 20px;"><a href="tel:${phone}" style="background: #ff6b35; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Call Customer</a></p>
        </div>
      `,
    })
